...
- Cluster -1 consists of users who demonstrate a broad spectrum of spending behaviors, characterized by their significant expenditures on both single item and installment-based purchases. These users maintain substantial emergency funds, indicating a high level of financial preparedness and a robust trust in the ShopEasy platform. Their consistent and substantial spending, coupled with a long account lifespan, underscores their deep engagement and loyalty. For ShopEasy, the strategy should focus on enhancing their premium services and offering exclusive deals to maintain this loyalty. Personalized marketing strategies should target these users with high-value product recommendations and tips on optimizing the use of emergency funds. Additionally, reinforcing loyalty programs with exclusive rewards can further cement their commitment to the platform.

**Cluster 0: Balanced, Premium Users**
- Cluster 0 is predominantly composed of premium users who exhibit balanced spending habits across single item purchases and installment-based purchases. These users maintain moderate emergency funds, reflecting a cautious but stable approach to their expenditures. Their consistent purchasing behavior, combined with a long account lifespan, suggests they are well-engaged with the platform and appreciate the benefits of premium membership. For this cluster, ShopEasy should focus on upselling opportunities by introducing premium add-ons and cross-selling complementary products. Enhancing their experience with personalized recommendations that highlight the value of premium membership can further drive engagement. Offering exclusive content and early access to sales and events can also enhance their perception of value and encourage continued loyalty.

**Cluster 1: Installment-Focused, Regular Users**
- Regular users in Cluster 1 exhibit a clear preference for installment-based purchases, with lower expenditures on single item purchases. They tend to maintain lower emergency funds, indicating a need for greater financial flexibility and possibly a more budget-conscious approach. Their engagement, while consistent, is marked by a slightly lower frequency of purchases compared to other clusters. For this group, ShopEasy should emphasize the availability and benefits of flexible payment plans and installment options. Providing educational content on financial management and the advantages of using installment purchases can help these users manage their finances better. Targeted promotions that offer incentives for installment-based purchases can also resonate well with their spending habits, encouraging more frequent and higher-value transactions.

**Cluster 2: Moderate-Spending, Student Users**
- Cluster 2 primarily includes student users who exhibit moderate spending patterns and a balanced approach to both single and installment-based purchases. These users maintain moderate emergency funds, indicating a combination of cautious and opportunistic spending behavior. Their long account lifespan suggests they are ongoing users of the platform, with potential for increased engagement as they transition out of student life. For ShopEasy, strategies should focus on introducing student discounts and budget-friendly options that cater to their financial constraints. Offering tools and resources for financial planning specifically tailored to students can help them manage their finances more effectively. Additionally, fostering a sense of community through student-focused events and content can enhance their overall experience and encourage loyalty to the platform as they move beyond their student years.
